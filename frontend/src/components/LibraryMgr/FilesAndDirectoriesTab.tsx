      ...
      <div className="flex flex-row space-x-2">
        <Button
          ...
          onClick={() => {
            ...
            APICall.setFileExts(arr2).then(() => setSaveFileExtsWorking(false));
          }}
        >
          Save Settings
        </Button>
        <Button
          ...
          onClick={() => {
            ...
            APICall.setMediafiles().then(() => setRefreshLibraryWorking(false));
          }}
        >
          Refresh Library
        </Button>
